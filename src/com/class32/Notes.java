...
//
//	Iterator is USED ONLY with Collections to retrieve element 1 by 1 and it iterates ONLY in 1 Direction. Iterator has 3 methods: hasNext(), next(), remove().
//
//	ArrayList vs Array
//	1. ArrayList is a dynamic in size (dynamic data structure) while array is a fixed size (satic data stucture)
//	2. ArrayList can store ONLY objects, while array can store object AND primitives
//	3. ArraList has a ready methods to remove,add (manipulate data) while array Does NOT have (you have to write your own logic to manipulate with Data)
